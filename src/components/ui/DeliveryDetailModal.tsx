                ...
                <div className="space-y-4">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div className="space-y-2">
                            <h2 className="text-2xl font-bold text-foreground">{delivery.id}</h2>
                            <h3 className="text-lg font-medium text-foreground">{delivery.cargo}</h3>
                        </div>
                ...
                {delivery.priority === 'urgent' && !isCompleted && (
                    <div className="flex items-center gap-3 p-4 bg-red-50 border border-red-200 rounded-lg">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-red-600">This delivery requires immediate attention</p>
                        </div>
                    </div>
                )}
            </div>
