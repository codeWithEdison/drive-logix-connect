...
export interface CargoDetail {
    id: string;
    status: 'active' | 'pending' | 'completed' | 'transit' | 'delivered' | 'cancelled';
    from: string;
    to: string;
    client?: string;
    driver?: string;
    ...
    return (
        ...
        >
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-gray-600">
                            {isDriverCargo ? `Assigned on ${cargo.assignedDate}` : `Created on ${cargo.createdDate}`}
                        </p>
                    </div>
                ...
                {(cargo.client || cargo.driver) && (
                    <Card>
                        <CardContent className="p-4">
                            <div className="flex items-center gap-3 mb-3">
                                <User className="h-5 w-5 text-blue-600" />
                                <h4 className="font-semibold text-gray-900">
                                    {isDriverCargo ? 'Client Information' : 'Driver Information'}
                                </h4>
                            </div>
                            <div className="space-y-2">
                                <p className="text-sm">
                                    <span className="font-medium">Name:</span> {cargo.client || cargo.driver}
                                </p>
                                <div className="flex items-center gap-2">
                                    <Phone className="h-4 w-4 text-gray-500" />
                                    <span className="text-sm">{cargo.phone}</span>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm font-semibold text-gray-900">{cargo.from}</p>
                                    ...
                                    {(cargo.pickupContact || cargo.pickupContactPhone) && (
                                        <div className="mt-2 p-2 bg-green-50 rounded-lg">
                                            ...
                                            {cargo.pickupContact && (
                                                <p className="text-xs text-gray-900">{cargo.pickupContact}</p>
                                            )}
                                            {cargo.pickupContactPhone && (
                                                <div className="flex items-center gap-1 mt-1">
                                                    <Phone className="h-3 w-3 text-gray-500" />
                                                    <span className="text-xs text-gray-900">{cargo.pickupContactPhone}</span>
                                                </div>
                                            )}
                                        </div>
                                    )}
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm font-semibold text-gray-900">{cargo.to}</p>
                                    ...
                                    {(cargo.deliveryContact || cargo.deliveryContactPhone) && (
                                        <div className="mt-2 p-2 bg-red-50 rounded-lg">
                                            ...
                                            {cargo.deliveryContact && (
                                                <p className="text-xs text-gray-900">{cargo.deliveryContact}</p>
                                            )}
                                            {cargo.deliveryContactPhone && (
                                                <div className="flex items-center gap-1 mt-1">
                                                    <Phone className="h-3 w-3 text-gray-500" />
                                                    <span className="text-xs text-gray-900">{cargo.deliveryContactPhone}</span>
                                                </div>
                                            )}
                                        </div>
                                    )}
                            ...
                            <div className="flex items-center gap-2 pt-2 border-t border-gray-100">
                                ...
                                <span className="text-sm text-gray-600">Distance: {cargo.distance}</span>
                                {cargo.vehicleType && (
                                    <span className="text-sm text-gray-600">• Vehicle: {cargo.vehicleType}</span>
                                )}
                            </div>
                        </div>
                    </CardContent>
                        ...
                        <CardContent className="p-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p className="text-sm font-semibold text-gray-900">{cargo.type}</p>
                                </div>
                                <div>
                                    <p className="text-xs text-gray-500">Weight</p>
                                    <p className="text-sm font-semibold text-gray-900">{cargo.weight}</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-semibold text-gray-900 capitalize">{cargo.status}</p>
                                </div>
                            </div>
                            {cargo.description && (
                            ...
                            {cargo.specialInstructions && (
                                <div className="mt-4 pt-4 border-t border-gray-100">
                                    ...
                                    <p className="text-sm text-gray-900">{cargo.specialInstructions}</p>
                                </div>
                            )}
                            {cargo.estimatedTime && (
                                <div className="mt-4 pt-4 border-t border-gray-100">
                        ...
                        <CardContent className="p-4">
                            ...
                            <div className="space-y-3">
                                <div>
                                    ...
                                    <p className="text-sm font-semibold text-gray-900">{cargo.id}</p>
                                </div>
                                <div>
                                    <p className="text-xs text-gray-500">Distance</p>
                                    <p className="text-sm font-semibold text-gray-900">{cargo.distance}</p>
                                </div>
                                {cargo.vehicleType && (
                                    <div>
                                        <p className="text-xs text-gray-500">Vehicle Type</p>
                                        <p className="text-sm font-semibold text-gray-900">{cargo.vehicleType}</p>
                                    </div>
                                )}
                                <div>
                                    <p className="text-xs text-gray-500">
                                ...
                                {cargo.pickupDate && (
                                    <div>
                                        ...
                                        <p className="text-sm font-semibold text-gray-900">{cargo.pickupDate}</p>
                                    </div>
                                )}
                                {cargo.deliveryDate && (
                                    <div>
                                        <p className="text-xs text-gray-500">Delivery Date</p>
                                        <p className="text-sm font-semibold text-gray-900">{cargo.deliveryDate}</p>
                                    </div>
                                )}
                            </div>
                        </CardContent>
