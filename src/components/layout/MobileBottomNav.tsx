...
export function MobileBottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-gradient-to-t from-white via-white/95 to-white/90 backdrop-blur-md border-t border-gray-200/50 shadow-lg md:hidden" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
