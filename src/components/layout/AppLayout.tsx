  ...
  if (isMobile) {
    return (
      <div className="flex flex-col min-h-screen w-full bg-[#F9FAFE]">
        {/* Mobile Header */}
        <header className="sticky top-0 z-40 w-full bg-[#F9FAFE]/80 backdrop-blur-md border-b border-white/20 group" style={{ paddingTop: 'calc(env(safe-area-inset-top, 0px) + 12px)', marginTop: '8px' }}>
