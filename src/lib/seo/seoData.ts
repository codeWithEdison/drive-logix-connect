...
export const BASE_URL = "https://lovewaylogistics.com";

export const DEFAULT_SEO = {
  title: "Loveway Logistics - Best Logistics Solutions in Rwanda | Cargo Tracking & Delivery Services",
...
export const PAGE_SEO: Record<string, {
  ...
  home: {
    title: "Loveway Logistics - Best Logistics Solutions in Rwanda | Cargo Tracking & Delivery",
  ...
  login: {
    title: "Login - Loveway Logistics | Access Your Logistics Dashboard",
    description: "Login to your Loveway Logistics account to track shipments, manage deliveries, and access your logistics dashboard in Rwanda.",
    keywords: "logistics login Rwanda, cargo tracking login, delivery management login Rwanda",
    path: "/login",
  },
  register: {
    title: "Register - Loveway Logistics | Start Shipping in Rwanda",
    description: "Create your Loveway Logistics account and start shipping across Rwanda. Fast, reliable, and secure cargo delivery services.",
    keywords: "register logistics Rwanda, sign up cargo delivery, create account logistics Rwanda",
    path: "/register",
  },
  tracking: {
    title: "Track Your Cargo - Real-time Tracking | Loveway Logistics Rwanda",
  ...
  createCargo: {
    title: "Create Cargo Shipment - Loveway Logistics Rwanda",
    description: "Create a new cargo shipment with Loveway Logistics. Fast, secure, and reliable delivery services across Rwanda. Book your shipment today.",
    keywords: "create cargo Rwanda, book shipment Rwanda, cargo booking, delivery booking Rwanda, ship cargo Rwanda",
    path: "/create-cargo",
  },
  myCargos: {
    title: "My Cargos - Manage Your Shipments | Loveway Logistics",
    description: "View and manage all your cargo shipments in one place. Track status, view history, and manage deliveries with Loveway Logistics.",
    keywords: "my cargo Rwanda, manage shipments, cargo management, delivery management Rwanda",
    path: "/my-cargos",
  },
  history: {
    title: "Delivery History - Loveway Logistics Rwanda",
    description: "View your complete delivery history with Loveway Logistics. Track past shipments, invoices, and delivery records in Rwanda.",
    keywords: "delivery history Rwanda, shipment history, cargo history, past deliveries Rwanda",
    path: "/history",
  },
  payment: {
    title: "Payment - Secure Payment Gateway | Loveway Logistics",
    description: "Make secure payments for your cargo shipments. Multiple payment options available for Loveway Logistics services in Rwanda.",
    keywords: "cargo payment Rwanda, logistics payment, delivery payment, secure payment Rwanda",
    path: "/payment",
  },
  invoices: {
    title: "Invoices - View Your Bills | Loveway Logistics",
    description: "View and download your invoices for all cargo shipments. Complete billing history and payment records with Loveway Logistics.",
...
export const generateOrganizationSchema = () => ({
  ...
  alternateName: "Loveway Logistics Platform",
  url: BASE_URL,
  ...
  sameAs: [
    "https://twitter.com/lovewaylogistics",
    "https://facebook.com/lovewaylogistics",
    "https://linkedin.com/company/lovewaylogistics",
  ],
});
