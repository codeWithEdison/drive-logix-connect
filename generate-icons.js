...
// Use logo-text.png instead of logo.png
const logoPath = path.join(__dirname, 'public', 'logo-text.png');
...
async function generateIcons() {
  try {
    ...
    console.log('Generating Android app icons from logo-text.png...');
    ...
    for (const [folder, dimensions] of Object.entries(splashSizes)) {
      ...
      console.log(`✓ Generated splash for ${portraitFolder} and ${landscapeFolder}`);
    }

    // Also update the default drawable splash
    const defaultSplashPath = path.join(androidResPath, 'drawable', 'splash.png');
    await sharp(logoPath)
      .resize(480, 320, {
        fit: 'contain',
    ...
    console.log('\n✅ All icons and splash screens generated successfully from logo-text.png!');
